...
HEADER_PAYLOADS: list[dict[str, Any]] = [
    {
        ...
        "values": ["127.0.0.1", "10.0.0.1", "192.168.1.1", "0.0.0.0", "localhost", "::1"],
        "type": "IP_SPOOF",
    },
    ...
    {
        "header": "Content-Type",
        "values": ["application/json", "application/xml", "text/xml", "application/x-www-form-urlencoded"],
        "type": "CONTENT_TYPE_SWITCH",
    },
...
JSON_PAYLOADS: list[dict[str, Any]] = [
    ...
    {"payload": {"__proto__": {"admin": True}}, "type": "PROTO_POLLUTION", "checks": ["proto"]},
    {
        ...
        "type": "PROTO_POLLUTION_CONSTRUCTOR",
        "checks": ["proto"],
    },
]
...
def _fuzz_parameters(url: str, session: requests.Session, discovered_params: list[str] | None) -> list[dict[str, Any]]:
