    ...
    try:
        ...
        iso_cr = bytes(
            [
                ...
                0x00,
                0x00,
                0x16,  # TPKT: version=3, length=22
                0x11,
                0xE0,
                0x00,
                0x00,  # COTP: length=17, CR (0xE0)
                0x00,
                0x01,
                0x00,
                0x01,  # DST/Source ref
                ...
                0x02,
                0x01,
                0x00,  # Parameter: calling TSAP
                0xC2,
                0x02,
                0x01,
                0x02,  # Parameter: called TSAP
                0xC0,
                0x01,
                0x09,  # Parameter: TPDU size
            ]
        )
        sock.send(iso_cr)
        ...
        try:
            ...
            hello = bytes(
                [
                    ...
                    0x50,
                    0x4E,
                    0x46,  # "OPNF" (OPC UA header)
                    0x00,
                    0x00,
                    0x00,
                    0x00,  # Message size (placeholder)
                ]
            )
            sock.send(hello)
            response = sock.recv(256)
