...
def _check_mobile_api_paths(target: str, base_url: str, session: requests.Session) -> list[dict[str, Any]]:
...
def _check_mobile_headers(target: str, base_url: str, session: requests.Session) -> list[dict[str, Any]]:
...
def _check_api_versioning(target: str, base_url: str, session: requests.Session) -> list[dict[str, Any]]:
...
def _check_cert_pinning(target: str, base_url: str, session: requests.Session) -> list[dict[str, Any]]:
...
def _check_debug_endpoints(target: str, base_url: str, session: requests.Session) -> list[dict[str, Any]]:
