...
MALICIOUS_NPM = [
    "crossenv", "cross-env.js", "node-ipc", "peacenotwar", "colors.js",
    "faker.js", "ua-parser-js", "coa", "rc", "event-stream",
    "flatmap-stream", "eslint-scope", "getcookies", "express-cookies",
    "node-opn", "nodemailer.js", "nodefabric", "nodesass",
    "npm-scripts-info", "babelcli", "crossenv", "cross-env.js",
    "crossenv.js", "mongose", "npm-debug-log.js", "smb",
    "sqlite3.js", "noderequest", "nodeffmpeg",
]

MALICIOUS_PYPI = [
    "python3-dateutil", "jeIlyfish", "jeIlyfish", "python-dateutil2",
    "colourama", "cColourama", "requesocks", "requesta",
    "requst", "urlib3", "urllib3-fake", "beautifulsoup",
    "lxml-fake", "crypto", "pynum", "pycrypto-fake",
    "setuptools-dev", "pip-dev", "12factor", "slackclient-fake",
    "boto3-dev", "awscli-dev", "django-dev", "flask-dev",
]

MALICIOUS_CARGO = [
    "rustdecimal", "serde_qs", "tokio-rs", "hyper-tls",
]
...
def _check_npm_supply_chain(target):
    ...
    npm_paths = [
        ...
        "/.npmrc", "/.yarnrc", "/.yarnrc.yml", "/lerna.json",
        "/nx.json", "/turbo.json",
    ]
...
def _check_pypi_supply_chain(target):
    ...
    pypi_paths = [
        ...
        "/poetry.lock", "/tox.ini", "/conda.yml", "/environment.yml",
    ]
...
def _check_dependency_confusion(target):
    ...
    registry_paths = [
        ...
        "/pip.conf", "/.pypirc", "/setup.cfg",
        "/.cargo/config", "/.cargo/config.toml",
        "/.gemrc", "/Gemfile", "/Gemfile.lock",
        "/go.mod", "/go.sum", "/.netrc",
    ]
    for path in registry_paths:
        try:
            ...
            internal_indicators = [
                ...
                "artifactory", "nexus", "private", "internal",
                "corp.", "company.", ".local", ".internal",
                "devpi", "gemfury", "cloudsmith", "jfrog",
                "packagecloud", "verdaccio",
            ]
