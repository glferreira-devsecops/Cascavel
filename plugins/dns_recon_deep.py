...
SUBDOMAIN_WORDLIST = [
    ...
    "api", "api2", "api3", "dev", "dev2", "development", "staging", "stage",
    "test", "testing", "sandbox", "qa", "uat", "demo", "preview", "beta",
    "alpha", "canary", "nightly", "rc", "pre",
    "app", "app2", "application", "portal", "dashboard", "panel", "console",
    "db", "database", "mysql", "postgres", "postgresql", "mongo", "mongodb",
    "redis", "elasticsearch", "elastic", "search", "solr", "cache",
    "cdn", "static", "assets", "media", "img", "images", "files", "uploads",
    "download", "downloads", "docs", "doc", "documentation", "wiki", "help",
    "support", "kb", "knowledge", "faq", "forum", "community",
    "blog", "news", "press", "status", "monitor", "monitoring", "grafana",
    "prometheus", "kibana", "log", "logs", "logging", "sentry",
    "ci", "cd", "jenkins", "gitlab", "github", "bitbucket", "git", "svn",
    "build", "deploy", "release", "artifacts", "registry", "docker",
    "k8s", "kubernetes", "kube", "rancher", "openshift", "mesos",
    "shop", "store", "ecommerce", "cart", "checkout", "payment", "billing",
    "invoice", "account", "my", "login", "signin", "auth", "sso", "oauth",
    "ldap", "ad", "directory", "iam", "identity",
    "internal", "intranet", "extranet", "private", "corp", "corporate",
    "office", "outlook", "exchange", "owa", "autodiscover", "mx",
    "backup", "bak", "old", "legacy", "archive", "mirror", "replica",
    "mobile", "m", "wap", "touch", "responsive",
    "analytics", "stats", "statistics", "report", "reports", "reporting",
    "crm", "erp", "hr", "finance", "accounting", "payroll",
    "iot", "edge", "node", "worker", "job", "jobs", "queue", "mq", "rabbit",
    "kafka", "stream", "events", "webhook", "callback", "notify",
    "chat", "im", "messaging", "sms", "voice", "voip", "sip", "telecom",
    "map", "maps", "geo", "location", "weather",
    "social", "media", "feed", "rss", "atom",
    "game", "gaming", "play", "match",
    "ai", "ml", "data", "bigdata", "hadoop", "spark", "pipeline",
    "cloud", "aws", "azure", "gcp", "alibaba", "heroku", "vercel", "netlify",
    "video", "stream", "live", "tv", "radio", "podcast",
    "go", "link", "redirect", "short", "url",
]
...
def _enumerate_subdomains(target):
    ...
    if found_subs:
        ...
        interesting = [s for s in found_subs if any(kw in s["subdomain"] for kw in [
