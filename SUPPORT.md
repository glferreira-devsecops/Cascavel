...
**[RET Tecnologia](https://rettecnologia.org)** · Open Source Security
...
3. **Verifique a instalação**:
   ```bash
   python3 cascavel.py --check-tools   # Ferramentas externas detectadas
   python3 cascavel.py --list-plugins  # Plugins carregados
   ```
...
| Prioridade | SLA |
|-----------|-----|
| 🔴 Crítico (segurança) | < 48h |
| 🟠 Alto (crash/data loss) | < 5 dias |
| 🟡 Médio (bug funcional) | < 14 dias |
| 🟢 Baixo (UX, cosmético) | Melhor esforço |

## 🚫 Fora do Escopo

- **Ferramentas de terceiros**: Problemas com nmap, nuclei, nikto → reporte nos respectivos projetos
- **Dependências Python**: Bugs em `requests`, `rich` → PyPI/GitHub do pacote
- **Uso não autorizado**: Não fornecemos suporte para atividades ilegais

---

<div align="center">

**Cascavel** é mantido por [RET Tecnologia](https://rettecnologia.org) · MIT License
