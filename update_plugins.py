...
for filepath in glob.glob("plugins/*.py"):
    ...
    if "def run(target, ip, open_ports, banners):" in content:
        content = content.replace(
            "def run(target, ip, open_ports, banners):", "def run(target, ip, open_ports, banners, context=None):"
        )
    elif "def run(target, ip, ports, banners):" in content:
        content = content.replace(
            "def run(target, ip, ports, banners):", "def run(target, ip, ports, banners, context=None):"
        )
