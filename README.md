...
- **44 Plugins de Segurança**: Cobertura completa de rede, web, cloud, OSINT, auth, wireless, OWASP Top 10, API Security e Cloud Security
...
10. **Execução de 30 Plugins**: Módulos de teste adicionais
11. **Relatório Final**: Markdown completo em `reports/`

## 🧩 Plugins

O Cascavel inclui **44 plugins** cobrindo diversas áreas de segurança. Consulte [PLUGINS.md](PLUGINS.md) para documentação completa.
...
├── plugins/              # 30 plugins de segurança
...
- Resultados de todos os 30 plugins executados
